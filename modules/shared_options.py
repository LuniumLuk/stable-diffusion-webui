...
options_templates.update(options_section(('optimizations', "Optimizations", "sd"), {
    ...
    "hires_force_sdp_attention": OptionInfo(True, "Hires fix: force SDP attention in second pass").info("temporarily switches to SDP attention for Hires second pass, then restores your configured optimization"),
    "img2img_force_sdp_attention": OptionInfo(True, "img2img: force SDP attention during sampling").info("temporarily switches to SDP attention for img2img sampling, then restores your configured optimization"),
    ...
    "img2img_use_hr_token_merging_fallback": OptionInfo(True, "img2img: fallback to hires token merging ratio").info("if img2img token merging ratio is 0, reuse token merging ratio for high-res pass as UNet inference speed optimization"),
